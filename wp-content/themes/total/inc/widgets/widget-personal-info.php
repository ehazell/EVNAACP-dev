...
class Total_Personal_Info extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                ...
                'description' => __('A widget to display Personal Information', 'total')
                )
        );
    }
