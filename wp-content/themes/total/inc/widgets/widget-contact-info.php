...
class Total_Contact_Info extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                ...
                'description' => __('A widget to display Contact Information', 'total')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            'title' => array(
                ...
                'total_widgets_title' => __('Title', 'total'),
                'total_widgets_field_type' => 'text',
            ),
            'phone' => array(
                'total_widgets_name' => 'phone',
                'total_widgets_title' => __('Phone', 'total'),
                'total_widgets_field_type' => 'text',
            ),
            'contact_info_email' => array(
                'total_widgets_name' => 'email',
                'total_widgets_title' => __('Email', 'total'),
                'total_widgets_field_type' => 'text',
            ),
            'website' => array(
                'total_widgets_name' => 'website',
                'total_widgets_title' => __('Website', 'total'),
                'total_widgets_field_type' => 'text',
            ),
            'address' => array(
                'total_widgets_name' => 'address',
                'total_widgets_title' => __('Contact Address', 'total'),
                'total_widgets_field_type' => 'textarea',
                'total_widgets_row' => '4'
            ),
            'time' => array(
                'total_widgets_name' => 'time',
                'total_widgets_title' => __('Contact Time', 'total'),
                'total_widgets_field_type' => 'textarea',
                'total_widgets_row' => '3'
            ),
        );
