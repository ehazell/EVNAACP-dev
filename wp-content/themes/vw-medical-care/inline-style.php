<?php
	...
	if($vw_medical_care_first_color != false){
		$custom_css .='a, #header .nav ul li a:hover, .footer li a:hover, .post-main-box:hover h3, .post-navigation a:hover .post-title, .post-navigation a:focus .post-title{';
