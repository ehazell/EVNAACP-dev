        ...
        $manager->add_section(
            new hasten_lite_Discount_Customize_Section_Pro(
                ...
                array(
                    ...
                    'pro_info'  => esc_html__('Why Pro?','hasten-lite'),
                    'pro_info1'  => esc_html__('Modern And clean design','hasten-lite'),
                    'pro_info2'  => esc_html__('20 Demos Available','hasten-lite'),
                    'pro_info3'  => esc_html__('Instant Demo Import','hasten-lite'),
                    'pro_info4'  => esc_html__('Premium Support','hasten-lite'),
                    'pro_info5'  => esc_html__('Multi Language Support','hasten-lite'),
                    'pro_info6'  => esc_html__('E-commerce Ready','hasten-lite'),
                    'pro_info7'  => esc_html__('Buy Premium','hasten-lite'),
                    'priority' => 1,
                )
            )
        );
